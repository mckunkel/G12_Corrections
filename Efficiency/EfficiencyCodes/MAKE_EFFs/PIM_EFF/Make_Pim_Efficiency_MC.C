...
void Make_Pim_Efficiency_MC(){
    ...
    if(Pull_Prob>0.01){
      ...
      if (PPip_Midz <= -105. && PPip_Midz > -110. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_I_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_I_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_I_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_I_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_I_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_I_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_I_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_I_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_I_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -100. && PPip_Midz > -105. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_II_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_II_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_II_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_II_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_II_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_II_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_II_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_II_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_II_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -95. && PPip_Midz > -100. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_III_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_III_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_III_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_III_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_III_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_III_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_III_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_III_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_III_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -90. && PPip_Midz > -95. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_IV_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_IV_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_IV_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_IV_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_IV_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_IV_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_IV_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_IV_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_IV_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -85. && PPip_Midz > -90. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_V_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_V_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_V_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_V_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_V_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_V_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_V_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_V_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_V_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -80. && PPip_Midz > -85. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_VI_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_VI_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_VI_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_VI_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_VI_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_VI_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_VI_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_VI_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VI_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -75. && PPip_Midz > -80. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_VII_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_VII_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_VII_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_VII_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_VII_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_VII_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_VII_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_VII_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VII_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
      ...
      if (PPip_Midz <= -70. && PPip_Midz > -75. ){
        ...
        if (Pim_Ptot_missing_fit <= 0.5 && Pim_Ptot_missing_fit > 0. ) {
          hmissing_VIII_I->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_I->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 0.75 && Pim_Ptot_missing_fit > 0.5 ) {
          hmissing_VIII_II->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_II->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1. && Pim_Ptot_missing_fit > 0.75 ) {
          hmissing_VIII_III->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_III->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 1.5 && Pim_Ptot_missing_fit > 1. ) {
          hmissing_VIII_IV->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_IV->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2. && Pim_Ptot_missing_fit > 1.5 ) {
          hmissing_VIII_V->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_V->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 2.5 && Pim_Ptot_missing_fit > 2. ) {
          hmissing_VIII_VI->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_VI->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 3. && Pim_Ptot_missing_fit > 2.5 ) {
          hmissing_VIII_VII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_VII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
        
        if (Pim_Ptot_missing_fit <= 5. && Pim_Ptot_missing_fit > 3. ) {
          hmissing_VIII_VIII->Fill(Pim_theta_missing_fit*sin(Pim_phi_missing_fit*TMath::Pi()/180.),Pim_theta_missing_fit*cos(Pim_phi_missing_fit*TMath::Pi()/180.));
          if (nPim == 1 && Pim_fidpass == 1 && Pim_tofKO  == 1) {hdetect_VIII_VIII->Fill(Pim_theta*sin(Pim_phi*TMath::Pi()/180.),Pim_theta*cos(Pim_phi*TMath::Pi()/180.));}
        }
  ...
  TFile fout("Efficiency_Plots_MC.root","recreate");
