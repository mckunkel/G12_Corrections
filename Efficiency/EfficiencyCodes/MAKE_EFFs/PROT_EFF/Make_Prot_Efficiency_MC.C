    ...
    if(Pull_Prob>0.01){
      ...
      if (PipPim_Midz <= -105. && PipPim_Midz > -110. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_I_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_I_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_I_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_I_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_I_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_I_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_I_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_I_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_I_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -100. && PipPim_Midz > -105. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_II_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_II_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_II_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_II_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_II_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_II_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_II_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_II_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_II_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -95. && PipPim_Midz > -100. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_III_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_III_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_III_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_III_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_III_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_III_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_III_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_III_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_III_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -90. && PipPim_Midz > -95. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_IV_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_IV_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_IV_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_IV_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_IV_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_IV_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_IV_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_IV_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_IV_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -85. && PipPim_Midz > -90. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_V_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_V_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_V_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_V_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_V_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_V_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_V_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_V_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_V_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -80. && PipPim_Midz > -85. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_VI_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_VI_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_VI_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_VI_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_VI_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_VI_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_VI_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_VI_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VI_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -75. && PipPim_Midz > -80. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_VII_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_VII_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_VII_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_VII_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_VII_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_VII_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_VII_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_VII_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VII_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
      ...
      if (PipPim_Midz <= -70. && PipPim_Midz > -75. ){
        ...
        if (P_Ptot_missing_fit <= 0.5 && P_Ptot_missing_fit > 0. ) {
          hmissing_VIII_I->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_I->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 0.75 && P_Ptot_missing_fit > 0.5 ) {
          hmissing_VIII_II->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_II->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1. && P_Ptot_missing_fit > 0.75 ) {
          hmissing_VIII_III->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_III->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 1.5 && P_Ptot_missing_fit > 1. ) {
          hmissing_VIII_IV->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_IV->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2. && P_Ptot_missing_fit > 1.5 ) {
          hmissing_VIII_V->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_V->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 2.5 && P_Ptot_missing_fit > 2. ) {
          hmissing_VIII_VI->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_VI->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 3. && P_Ptot_missing_fit > 2.5 ) {
          hmissing_VIII_VII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_VII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
        
        if (P_Ptot_missing_fit <= 5. && P_Ptot_missing_fit > 3. ) {
          hmissing_VIII_VIII->Fill(P_theta_missing_fit*sin(P_phi_missing_fit*TMath::Pi()/180.),P_theta_missing_fit*cos(P_phi_missing_fit*TMath::Pi()/180.));
          if (nProt== 1 && P_fidpass== 1 && P_tofKO  == 1 ) {hdetect_VIII_VIII->Fill(P_theta*sin(P_phi*TMath::Pi()/180.),P_theta*cos(P_phi*TMath::Pi()/180.));}
        }
