...
void Make_Pim_EfficiencyTH3D_MC(){
  ...
  TH3D *hmissing =new TH3D("hmissing","Reconstructed" ,25,0.1,4.35,25,0,100,90,-180,180);
  hmissing->SetXTitle("P [GeV] ");
  hmissing->SetYTitle("#theta [#circ] ");
  hmissing->SetZTitle("#phi [#circ] ");
  hmissing->Sumw2();
  
  TH3D *hdetect =new TH3D("hdetect","Detected" ,25,0.1,4.35,25,0,100,90,-180,180);
  hdetect->SetXTitle("P [GeV] ");
  hdetect->SetYTitle("#theta [#circ] ");
  hdetect->SetZTitle("#phi [#circ] ");
  hdetect->Sumw2();
  
  TH3D *hEff =new TH3D("hEff","Efficiency" ,25,0.1,4.35,25,0,100,90,-180,180);
  ...
  TFile fout("Efficiency_Plots3D_MC_Pim.root","recreate");
